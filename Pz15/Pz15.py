# ПЗ №15, Вариант 12
# Приложение ТЕЛЕМАСТЕРСКАЯ — автоматизированный контроль работ по ремонту.
# Таблица «Ремонт телевизоров»:
#   id, Марка телевизора, Завод-изготовитель, Цена, Дата ремонта,
#   Документ, Мастер, Сумма оплаты.
#
# Функционал: ввод (10 позиций), поиск, удаление, редактирование.
# Для каждой операции — по три SQL-запроса.
